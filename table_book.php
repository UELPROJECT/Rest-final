...
?>								  
                                ...
                                <form name ="f1" method="post" action="table_book.php"> 
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>TOTAL</p>
                                        <h3 class="value" id ="total_table_price"><strong></strong></h3>
                                        ...
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn theme-btn btn-lg disabled">RESERVE TABLE</a>

                                        <?php
                                        }
                                        else{   
                                        ?>
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn theme-btn btn-lg active">RESERVE TABLE</a>
                                        <?php   
                                        }
                                        ?>
                              ...
                              <?php
                                ...
                                while($row=mysqli_fetch_array($tq)){
                                    ...
                                    for ($i=0;$i<$row['total_table'];$i++){
                                        echo '<h2><input type="checkbox" id= '.$row['rs_id'],' name= "Table" onclick="checkCont('.$i.')" value ='.$row['total_tbl'].' > &nbsp;&nbsp;Table '.$t.'</input></h2><br/>';    
                                        $t++;
                                    }
