                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 483 483" width="500" height="512">
                                <g fill="#FFF">
                        ...
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="412" height="512" viewbox="0 0 380.721 380.721">
                                <g fill="#FFF">
                            ...
                            <h4><span>2. </span>Order Food & <br > Reserved Tables </h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery or Dine In</h4> </div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a dish Or Book Table</h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Delivery Or Dine In</h3>
                                <p>Get your food delivered! Orelse enjoy your meal at hotel! </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Cash Or Online Pay </p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>UEL</h5>
                                    <p>Group project by Ravi , Darsh , Nerali and Arthai.</p>
                                    <h5><a href="https://chat.whatsapp.com/HGAlgWary6EAsl3MYp7ehj"><img style="heght: 20px;weight: 20px;" src="images/img/app.jpg"></a> </h5> </div>
